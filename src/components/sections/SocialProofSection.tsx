...
const testimonials = [
  {
    ...
    quote: "A Ferdian-MSP não entregou um serviço, mas uma parceria estratégica. A curadoria deles foi fundamental para nosso aumento de 40% em leads qualificados em um único trimestre.",
    rating: 5,
  },
  {
    id: "testimonial-2",
    ...
    quote: "Trabalhar com a Ferdian-MSP nos deu a clareza que precisávamos. O processo de validação deles garantiu que cada real investido tivesse retorno máximo. Os resultados foram transformadores.",
    rating: 5,
  },
  {
    id: "testimonial-3",
  ...
  return (
    <section id="social-proof" className="py-16 sm:py-24 bg-secondary/50 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto text-center">
            <h2 className="text-3xl font-bold md:text-4xl font-headline text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-600">Resultados, Não Promessas</h2>
